...
def process_trajectory(latest_traj_num, dvl_input_file, imu_input_file):
    ...
    beams_output = dvl_df[["Time", "b_vel0", "b_vel1", "b_vel2", "b_vel3"]].rename(
    ...
    print(f"DEBUG: Processed beams data saved to: {beams_output_path}")

    # Validate required columns for velocity output from DVL
