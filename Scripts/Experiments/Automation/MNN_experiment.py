...
PLOTS_DIR = "../../Experiments/Results_New/MNN/Plots/"
...
initial_learning_rate_2 = learning_rate_2
...
def train_model(trajectory_id, data_file, a, b):
    global learning_rate, dropout_rate, hidden_neurons, stacking_count, epochs,learning_rate_2
    ...
    while attempt < number_of_trials:
        model = MemoryNeuralNetwork(
            ...
            number_of_output_neurons=3,learning_rate=learning_rate,
        ...
        plot_path = os.path.join(PLOTS_DIR, f"MNN_lr{learning_rate}_drop{dropout_rate}_{trajectory_id}_hid{hidden_neurons}_ep{epochs}_stack{stacking_count}_a{a}_b{b}.png")
        plt.figure()
    ...
    learning_rate_2 = initial_learning_rate_2
