...
CHECKPOINT_DIR = "../../Experiments/Results_New/FAN/Checkpoints_MNN/"
PLOTS_DIR = "../../Experiments/Results_New/FAN/Plots/"
LOG_FILE = "experiment_log_FAN.txt"
DATA_DIR = "../../../Data"
...
def train_model(trajectory_id, data_file, a, b):
    ...
    while attempt < number_of_trials:
        model = FAN(
            number_of_input_neurons = num_inputs, number_of_hidden_neurons = hidden_neurons, number_of_output_neurons=3, 
                 num_layers=3,learning_rate=learning_rate, lambda_reg=0.001
        ).to("cuda")
        ...
        plot_path = os.path.join(PLOTS_DIR, f"FAN_lr{learning_rate}_drop{dropout_rate}_{trajectory_id}_hid{hidden_neurons}_ep{epochs}_stack{stacking_count}_a{a}_b{b}.png")
        plt.figure()
